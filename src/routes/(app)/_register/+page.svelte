...
<form use:enhance use:autoanimate class="registration-form container max-w-3xl mx-auto px-6 mt-10" method="POST">
	...
	{#if data.event.team_members.length > 1 || !data.event.team_members.includes(1)}
		<h3 class="mb-6 text-base font-medium text-gray-900 dark:text-gray-400">
	...
	{#if teamMemberSelected > 0}
		<h4
			...
			class="mb-2 text-base font-medium text-gray-900 dark:text-gray-400"
		>
