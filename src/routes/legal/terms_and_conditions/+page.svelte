...
<div class="compalinace-content">
	<div class="content-container prose">
		...
		<p class="content-text">
			...
			conditions, the privacy policy and any other relevant terms and conditions, policies and
		...
		<p class="content-text">
			...
			privacy policy govern Adhyaaya'23''s relationship with you in relation to this website.
		</p>
		<p class="content-text">
			The term 'Adhyaaya'23' or 'us' or 'we' refers to the owner of the website whose
		...
		<ul class="unorder-list">
			...
			<li class="list-item">
				<p class="content-text list-text">
					...
					Adhyaaya'23’s prior written consent.
				</p>
			</li>
			<li class="list-item">
				<p class="content-text list-text">
