...
<head>
  ...
  <title>Adhyaaya'23 | {{event}} Registration </title>
          ...
          <tr>
            <td align="center" valign="top" style="padding: 36px 24px;">
              <a href="https://adhyaaya.org" target="_blank" style="display: inline-block;">
                <img src="https://adhyaaya.org/favicon.png" alt="Logo" border="0" width="48" style="display: block; width: 48px; max-width: 48px; min-width: 48px;">
              </a>
            </td>
          </tr>
        </table>
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 300px;">
                  <tr>
                    <td align="left" valign="top" style="padding-bottom: 36px; padding-left: 36px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                      ...
                      <p>Government College of Engineering, <br />Sector-27, Mihan Rehabilitation Colony, <br />Khapri, Nagpur - 441108<br />3326+M2 Nagpur, Maharashtra</p>
                    </td>
                  </tr>
                </table>
              </div>
