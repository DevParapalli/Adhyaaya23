	...
	<div class="modal-wrapper relative h-full w-full z-[210] bg-black/50">
		...
		>
			...
			<div class="content-container flex flex-col items-baseline lg:w-2/3 px-6 pt-6 bg-purple-900">
				...
				<div
					class="button-container flex lg:flex-row flex-col justify-around gap-4 w-full mt-4 mb-4"
				>
					<button
						on:click={async () => {
							closeModal();
						...
						class="register-btn w-full lg:w-1/2 bg-green-500 rounded-lg p-2 hover:scale-105 active:scale-95 active:opacity-90 transition-all duration-300 ease-in-out uppercase"
						>Register</button
					>
					<a
						target="_blank"
						...
						class="learn-more-btn text-center w-full lg:w-1/2 bg-blue-500 rounded-lg p-2 hover:scale-105 active:scale-95 active:opacity-90 transition-all duration-300 ease-in-out uppercase"
						>Learn More</a
					>
				</div>
			</div>
