...
<div class="wrapper w-full h-full flex items-center text-left relative">
	<div class="main w-full ml-[8.33333333333333334%] md:ml-[16.66666666667%]">
		<div
			class="big-text w-5/6 md:w-7/12 text-3xl xl:text-5xl 2xl:text-6xl bg-clip-text text-transparent hemnder font-extralight leading-[3.5rem] xl:leading-[5.5rem] 2xl:leading-[7rem]"
		>
			Redefining possibilities with Multiverse and AI, Adhyaaya'23
		</div>
	</div>
	{#if scrollPos < 35}
		<div
		...
		>
			SCROLL TO EXPLORE
			<div class="scroll-line mt-6 md:mt-10 h-20  w-1 bg-red-500" />
		</div>
	{/if}
</div>
