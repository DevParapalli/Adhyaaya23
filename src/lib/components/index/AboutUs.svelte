...
<div class="about-us-container h-full md:w-5/6 flex flex-col items-center justify-evenly md:py-10 mx-auto px-2">
    ...
    <div class="our-college w-1/2 hidden xl:flex flex-col items-center justify-evenly h-full text-justify bg-white/20 backdrop-blur-sm rounded-lg border border-white lg:border-r-0 lg:rounded-r-none p-4 gap-2">
        ...
        <p class="max-w-lg text-lg nunu">Lorem ipsum dolor sit amet consectetur adipisicing elit. Dignissimos possimus asperiores vitae nulla atque quasi ratione consectetur temporibus illum rerum, velit cum expedita quidem porro maxime sit, a debitis soluta.</p>
    ...
    <div class="us w-full xl:w-1/2 flex flex-col items-center justify-evenly h-full text-justify bg-black/40 backdrop-blur-sm rounded-lg border border-white lg:rounded-l-none p-6 gap-2">
        ...
        <p class="max-w-lg md:text-lg nunu">Lorem ipsum dolor sit amet consectetur adipisicing elit. Vero doloribus unde libero accusantium blanditiis exercitationem molestiae explicabo nesciunt quod fuga. Provident eveniet beatae quibusdam repudiandae qui praesentium, nulla sed magni.</p>
