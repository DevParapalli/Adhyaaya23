	...
	<div class="content flex flex-row w-full h-4/6">
		...
		>
			...
			<a
				data-sveltekit-reload
				href="/team"
				class="team-button relative px-5 py-3 text-xl bg-gradient-to-tr from-pink-500 via-red-500 to-yellow-500 rounded-lg inline-flex items-center uppercase gap-2 hover:scale-110 active:scale-90 active:opacity-90 transition-all duration-300 ease-in-out mb-8"
