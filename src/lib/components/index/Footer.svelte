...
<div class="md:h-full pt-32
 w-11/12  m-auto flex flex-col lg:flex-row items-stretch justify-evenly pb-4">
    <div class="h-full lg:w-1/3 bg-purple-900/10 order-2 lg:order-1 p-4">
    ...
    <div class="h-full lg:w-1/3  flex flex-col order-3 lg:order-2">
        ...
        <div class="h-1/6 w-full bg-white/20 flex flex-row items-center justify-evenly py-8 text-white">
