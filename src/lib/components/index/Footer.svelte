...
<div class="md:h-full pt-32
 w-11/12  m-auto flex flex-col lg:flex-row items-stretch justify-evenly pb-4">
    ...
    <div class="flex flex-col items-stretch justify-evenly p-4 h-1/2">
        ...
        <a href="/legal/terms_and_conditions" class="btn btn-ghost text-lg hover:text-white">T &amp; C</a>
        <a href="/legal/privacy_policy" class="btn btn-ghost text-lg hover:text-white">Privacy Policy</a>
    ...
    <div class="h-full lg:w-1/3  flex flex-col order-3 lg:order-2">
        ...
        <div class="h-1/6 w-full bg-purple-900/20 flex flex-row items-center justify-evenly py-8 text-white">
        <a href="mailto:adhyaaya.gcoen@gmail.com" class="email h-8 w-8 lg:h-12 lg:w-12 bg-sky-500 rounded-full text-2xl lg:text-4xl inline-flex items-center justify-center hover:scale-105 active:scale-95 active:opacity-95 transition-all duration-300 ease-in-out"><iconify-icon icon="mdi:email-outline"/></a>
        <a href="https://www.linkedin.com/company/adhyaaya/" class="linkedin h-8 w-8 lg:h-12 lg:w-12 bg-blue-500 rounded-full text-2xl lg:text-4xl inline-flex items-center justify-center hover:scale-105 active:scale-95 active:opacity-95 transition-all duration-300 ease-in-out"><iconify-icon icon="mdi:linkedin"/></a>
        <a href="https://instagram.com/adhyaaya.gcoen" class="instagram h-8 w-8 lg:h-12 lg:w-12 bg-purple-500 rounded-full text-2xl lg:text-4xl inline-flex items-center justify-center hover:scale-105 active:scale-95 active:opacity-95 transition-all duration-300 ease-in-out"><iconify-icon icon="mdi:instagram"/></a>
        <a href="https://www.youtube.com/@ADHYAAYAGCOEN" class="youtube h-8 w-8 lg:h-12 lg:w-12 bg-red-500 rounded-full text-2xl lg:text-4xl inline-flex items-center justify-center hover:scale-105 active:scale-95 active:opacity-95 transition-all duration-300 ease-in-out"><iconify-icon icon="mdi:youtube"/></a>
        </div>
    </div>
